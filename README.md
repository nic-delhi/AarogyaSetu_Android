...
![Aarogya Setu Logo](./aarogya.png "Aarogya Setu Logo")
...
If you find any security issues or vulnerabilities in the code, then you can send the details to us at : [as-bugbounty@nic.in](mailto:as-bugbounty@nic.in)

If you want to convey any other feedback regarding the App or Code, then you can send it to us at : [support.aarogyasetu@nic.in](mailto:support.aarogyasetu@nic.in)
...
Setup a keystore.properties file at the root folder with the following sample detail and your configurations
```
# Server SSL Keys
...
Download the google-services.json file for each of the environments and put it in the corresponding folder.
